...
from organization_helpers import save, load, initial_semantic_focus, filter_long_and_short_notes, tag_media_notes, tag_nostr_notes
from chromadb_wrapper import set_up_database, upload_embeddings_to_database, query_database_string, query_database_embedding
...
query_result = query_database_embedding(database, semantic_focus,n_results=5)
